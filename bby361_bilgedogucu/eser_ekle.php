    ...
    <h2>Eser Ekleme Formu</h2>
        <form method="post" action="eser_ekle2.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="formControl1" name="eserISBN">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="formControl3" name="eserBasimYeri">
            </div>
            <div class="mb-3">
                <label for="formControl1" class="form-label">Eser Basım Tarihi</label>
                <input type="text" class="form-control" id="formControl3" name="eserBasimTarihi">
            </div>
            <div class="mb-3">
                <label for="formControl1" class="form-label">Eser Sayfa Sayısı</label>
                <input type="text" class="form-control" id="formControl3" name="eserSayfaSayisi">
            </div>
            <div class="mb-3">
                <label for="formControl1" class="form-label">Eser Dili</label>
                <input type="text" class="form-control" id="formControl3" name="eserDili">
            </div>
            <div class="mb-3">
